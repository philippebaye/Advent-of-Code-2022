...
#=====================================================
# Identify nodes, with cumulative size at most 100.000
#=====================================================
NODE_SIZE_LIMIT = 100_000

candidate_nodes = {node: full_size for node, full_size in nodes_full_size.items() if full_size <= NODE_SIZE_LIMIT}
sum_of_candidate_nodes_size = sum(candidate_nodes.values())

print(f"candidate nodes: {candidate_nodes}")
print(f"sum of candidate nodes size: {sum_of_candidate_nodes_size}")
print("-------------------------")
