...
with open(input_file_name) as input_file:
    for line in input_file:
        ...
        if not is_starting_description_arrangement:
            ...
            crates_to_move = arrangement[move_stack_from-1][:move_count]
            arrangement[move_stack_from-1] = arrangement[move_stack_from-1][move_count:]
            #print(f"{crates_to_move}, {arrangement[move_stack_from-1]}")
            arrangement[move_stack_to-1] = crates_to_move + arrangement[move_stack_to-1]
